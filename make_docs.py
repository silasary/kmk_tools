...
def gather_data(games):
    ...
    seed = random.Random()
    opt_dict = {option_key: option.from_any(option.default) for option_key, option in KeymastersKeepOptions.type_hints.items()}
